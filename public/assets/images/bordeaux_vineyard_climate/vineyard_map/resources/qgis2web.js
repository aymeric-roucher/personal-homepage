...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-2079471.407186, 3651685.200215, 4774530.554010, 7044006.318084], maxZoom: 10, minZoom: 5
    })
});


map.getView().fit([-2079471.407186, 3651685.200215, 4774530.554010, 7044006.318084], map.getSize());
