        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="abbey-card group">
            ...
            <h3 className="abbey-heading text-xl mb-2 group-hover:text-primary transition-colors">
              <Link to="/projects/project-1">Project Title One</Link>
            </h3>
            ...
            <div className="flex items-center space-x-4 text-sm">
              <a href="#" className="abbey-link flex items-center space-x-1">
          ...
          <div className="abbey-card group">
            ...
            <h3 className="abbey-heading text-xl mb-2 group-hover:text-primary transition-colors">
              <Link to="/projects/project-2">Research Project</Link>
            </h3>
          ...
          <div className="abbey-card group">
            ...
            <h3 className="abbey-heading text-xl mb-2 group-hover:text-primary transition-colors">
              <Link to="/projects/project-3">Creative Work</Link>
            </h3>
          ...
          <div className="abbey-card group">
            ...
            <h3 className="abbey-heading text-xl mb-2 group-hover:text-primary transition-colors">
              <Link to="/projects/project-4">Open Source Tool</Link>
            </h3>
