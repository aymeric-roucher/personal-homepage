...
| Chip | Arch | AI throughput | Power | TOPS/W | ~Price | Maker (fab) | Named platforms | ~Drones equipped, 2025 (order of magnitude) |
|---|---|---|---|---|---|---|---|---|
| NXP i.MX 8M Plus | NPU SoC | 2.3 TOPS | 4-6 W | ~0.5 | \$15-45 | NXP (TSMC) | Auterion Skynode S, Ukrainian strike FPVs | ~30,000+ (the Pentagon contract alone puts 33,000 Skynode kits on Ukrainian drones) |
| Rockchip RK3588 | NPU SoC | 6 TOPS | 5-12 W | ~0.5-1.2 | \$60-100 | Rockchip (SMIC, China) | TFL-1, Vyriy, captured Russian FPVs | Tens of thousands and scaling fast (TFL-1 sold on DOT-Chain; Russian copies) |
| NVIDIA Jetson TX2 | GPU | 1.3 TOPS | 7.5-15 W | ~0.1-0.2 | ~\$220 | NVIDIA (Samsung) | ZALA Lancet | Low thousands (Lancet-family annual production) |
| NVIDIA Jetson Xavier NX | GPU | 21 TOPS | 10-20 W | ~1-2 | ~\$350 | NVIDIA (Samsung) | Shield AI V-BAT, Anduril Ghost | Hundreds |
| NVIDIA Jetson Orin Nano | GPU | 40-67 TOPS | 7-25 W | ~3-5 | \$249 | NVIDIA (Samsung) | Quantum Vector (dual-SoC) | ~1,000-2,000 aircraft (two chips each) |
| NVIDIA Jetson Orin NX | GPU | 70-157 TOPS | 10-25 W | ~6-7 | ~\$599 | NVIDIA (Samsung) | Anduril Fury / Bolt-M | Hundreds (early production ramps) |
| Hailo-10H | Dataflow NPU | 40 TOPS | ~2.5 W | ~16 | ~\$130 w/ Pi | Hailo (TSMC) | Cheap FPV + host board | Low thousands (retrofit boards, early adoption) |
| Axelera Metis | RISC-V NPU | 214 TOPS | ~14 W | ~15 | M.2 module | Axelera (TSMC N12) | Robotics, vision inference | ~0 flying yet: shipped at volume only in 2025, and it is a PCIe accelerator card, so it needs a host computer to run the OS, cameras and its driver (a Jetson IS the computer). Its [young software stack](https://medium.com/@zlodeibaal/axelera-ai-metis-m-2-first-impressions-849a67f09dc1) matured on x86 hosts first; support for the low-power ARM boards small drones use as hosts is still being brought up. Not a price problem |
