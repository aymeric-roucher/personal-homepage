...
<div class="my-8 p-6 bg-card border border-border rounded-lg shadow-sm">
  <div style="text-align: center;">
    <iframe src="/assets/images/bordeaux_vineyard_climate/vineyard_map/index.html" height="570px" width="100%" style="border:none; border-radius: 4px;"></iframe>
    <p class="mt-4 mb-0 text-sm text-card-foreground/70 italic leading-relaxed">
