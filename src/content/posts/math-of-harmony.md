...
- **Whole steps and half steps** never show up as consonant intervals; by this model they are simply dissonant. They likely enter music as *differences* between consonant intervals (a half step is the gap between a third and a fourth) rather than as intervals meant to sound good simultaneously.
