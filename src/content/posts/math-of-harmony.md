...
- **Harmony is dynamic, and this model is static.** Everything above scores a chord frozen in isolation, as if music were a sequence of independent photographs. But real music *uses* dissonance: it is tolerated, and often deliberately sought, to create tension, emotion, and motion toward somewhere else. In Schubert's *Erlkönig*, the sick child's terrified cries of "Mein Vater, mein Vater!" are pitched to grind a ninth against the piano's harmony, among the harshest dissonances available, and each successive cry screws the pitch higher; the anguish only releases when the father's calm answering phrase restores consonance. On this post's map, those cries are just high-altitude points, bad chords. In the song, they are the whole point: the dissonance is the child's fear made audible, and its later resolution is the comfort. A model that only measures roughness has nothing to say about why a composer would climb a peak on purpose, or about the release of coming back down.
...
Even with those caveats, the punchline stands: a huge chunk of music theory, the part everyone assumed was arbitrary culture or divine integer mysticism, falls out of two exponentials fitted to a 1965 listening experiment, summed over overtones. So no, this does not explain all of music; it explains some of the harmony. It lays down the architectural ground rules inside which creativity and expression happen. It is the physics of the ballet: the choreography remains the act of creation.
