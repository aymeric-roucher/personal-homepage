...
date: 2026-04-14
type: blog
url: how-producthunt-botched-our-launch
---
...
- Headline: mention what distinguishes our product rather than corporate-sounding fluff.  
- Thumbnail video: my video follows the Marc Louvion playbook: just do something funny featuring yourself, preferably from a well-known reference. [Example](https://x.com/marclou/status/1723974769593499938). So I had done the banger release video below:
...
So I published and… absolutely nothing. ProductHunt had recently (March 2026) introduced a feature called [Randomized Leaderboard](https://www.producthunt.com/p/producthunt/introducing-randomized-leaderboard-day-on-product-hunt), enabled on certain days, where for the first few hours of the day, rankings on the leaderboard would be randomized for each visitor, and upvote counts wouldn’t even show for product owners. The idea is to let all products have their chance to sometimes figure on top even if they weren’t kickstarted by the upvotes of a large social media following. So I didn't worry and waited for that randomized time to end.
...
This was despite my cofounder upvoting and commenting (for some reason I couldn’t add him as a co-maker in there). So where did his comment go? I asked but he had gone to sleep (the hours building up to the release were intense, and we'd had little sleep), so I waited for his answer.

Fast forward to 8PM: at this point it felt like the release was bugged. How was it possible to get 0 upvotes and comments in the whole day? Was our product even correctly published, or did I make a mistake in the date? 
...
So the upvote counter was unlocked. But by then it was way too late to catch up on the leaderboard, leaders had hundreds of upvotes by then (that’s why all playbooks recommend posting at 00:01 AM PST sharp)

What we did wrong:

- We should have played the reputation game more and secured upvotes from well-known hunters in the first minutes  
...
This is honestly good feedback: not all upvotes are equal.
...
Also, I had a previous launch, [Predibench](https://www.producthunt.com/products/predibench/launches/predibench). Predibench had the exact same release process (tell friends to upvote + share on socials) and got a normal upvote curve. 
...
So that’s the takeaway I’d give others trying to launch on ProductHunt: **avoid shadowbanning by getting upvotes from reputable, established accounts as early as possible.**
